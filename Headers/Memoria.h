...
#ifndef Graphbot_Memoria_h
#define Graphbot_Memoria_h
...
float Memoria::getTemporal(int dir){
    int direccionReal = dir - offset_temporales;
    if(rangoCorrecto(direccionReal) && &temporales[direccionReal] != __nullptr){
...
float Memoria::getFlotante(int dir){
    int direccionReal = dir - offset_variablesFlotantes;
    if(rangoCorrecto(direccionReal) && &variablesFlotantes[direccionReal] != __nullptr){
...
int Memoria::getLista(int dir){
    int direccionReal = dir - offset_variablesListas;
    if(rangoCorrecto(direccionReal) && &variablesListas[direccionReal] != __nullptr){
