...
%token <sval> RW_SHOW RW_HIDE RW_CLEAN RW_HOME RW_GETCOLORR RW_GETCOLORB RW_GETCOLORG RW_GETPENSIZE RW_GETX RW_GETY RW_STOPMUSIC RW_PLAYMUSIC RW_ABOUT RW_PENUP RW_PENDOWN 
...
void errores(int i, string val) {
	switch (i) {
        ...
        case 4:
			cout << "Cantidad de parámetros errónea en función " << val << " esperaba " << directorio.num_Param(val) << " recibí " << param << " parametros.   " <<endl;
			exit(-1);
		break;
